...
* How can we adapt tools from *computer science* to allow *social scientists* and *humanists* to make meaningful inferences?
...
<tr>
<th></th>
<th class="bb">Dependency Tree</th>
<th>5-Word Window</th>
<th></th>
</tr>
<tr>
<td class="bb tb">Co-Hyponyms (Paradigmatic) $\rightarrow$</td>
<td class="ln tb bn">Pauling</td>
<td class="rn bn lb">nondeterministic</td>
<td class="bb">$\leftarrow$ Topically Related (Syntagmatic)</td>
</tr>
<tr>
<td class="bn"></td>
...
## Innovation and Influence in Twentieth Century Marxism
...
## Fi Hadal Habs: Anonymous Communiqués of the First Intifada
...
## Relative Focus: Zooming In

<center>
![](topics_by_group_sub.svg){width="90%"}
</center>
